...
public class SmsDemo {
    ...
    public static SendSmsResponse sendSmsTask(String mobile) throws ClientException {
        ...
        request.setSignName("51offer");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_148614175");
        //可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
        //request.setTemplateParam("{\"name\":\"代安娜\"}");
    ...
    public static QuerySendDetailsResponse querySendDetails(String bizId) throws ClientException {
        ...
        //必填-号码
        request.setPhoneNumber("17621053900");
        //可选-流水号
